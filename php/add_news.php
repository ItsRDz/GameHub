...
// This page lets an admin add a news.
...
if (isset($_POST['submitted'])) {
    ...
    if (empty($errors)) { // If everything's OK.
        ...
        // Make the query:
        $q = "INSERT INTO news (news_title, news_text, genre, platform, image) VALUES ('$title', '$desc', '$genre', '$platform', '$image')";		
...
<form class="form-signin"  method="POST" action="add_news.php">
